...
export class AvenxComponent {
  ...
  runUpdate() {
    ...
    try {
      ...
      const updateFn = this.#methods.onUpdate || (typeof this.onUpdate === 'function' ? this.onUpdate.bind(this) : null);
  ...
  unmount() {
    ...
    const unmountFn = this.#methods.onUnmount || (typeof this.onUnmount === 'function' ? this.onUnmount.bind(this) : null);
    if (unmountFn) {
      try {
        unmountFn();
      } catch (error) {
