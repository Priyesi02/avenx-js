...
try {
    ...
    assert.strictEqual(statementResultA, undefined, 'executeStatement returns undefined for expression statements (no return)');
    ...
    assert.strictEqual(statementResult8, 'Hello, world', 'Statement with return should use thisArg for "this" and name from with(thisArg)');
    ...
    const methods3 = {
        getDouble: function () { return this.state.value * 2; },
        getTriple: function () { return this.state.value * 3; },
    };
